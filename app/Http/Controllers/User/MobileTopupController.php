...
class MobileTopupController extends Controller
{
    public function index() {
        ...
        return view('user.sections.mobile-top.index',compact('page_title','sender_wallets','charges','transactions','topup_type'));
    }
    ...
    public function insertSenderCharges($id,$charges,$sender_wallet) {
        ...
        try{
           ...
           //admin notification
           $notification_content['title'] = "Mobile Topup request send to admin  ".$charges['sender_amount'].' '.$charges['sender_currency'].' Successful ('.$sender_wallet->user->username.')';
