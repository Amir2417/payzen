...
class AgentController extends Controller
{
    ...
    public function home(){
        ...
        $totalTransactions =Transaction::agentAuth()->where('status', 1)->count();
        ...
        $transactions = Transaction::agentAuth()->latest()->take(5)->get()->map(function($item){
        ...
        "image_path"  =>  "public/frontend/agent",
        'user'         =>   $user,
        'totalAddMoney'   =>  getAmount($totalAddMoney,2),
        'totalReceiveRemittance'   =>  getAmount($totalReceiveRemittance,2),
        'totalSendRemittance'   =>  getAmount($totalSendRemittance,2),
        
        'billPay'   =>  getAmount($billPay,2),
        'topUps'   =>  getAmount($topUps,2),
