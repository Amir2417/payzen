                        ...
                        <tbody>
                            @forelse ($refer_users as $item)
                                <tr>
                                    ...
                                    <td data-label="Refer Code">{{ $item->user->referral_id }}</td>
                                    <td data-label="Joined Date">{{ $item->user->created_at->format('d-m-Y') }}</td>
                                    <td data-label="Referred Users">{{ $item->user->referUsers->count() }}</td>
                                </tr>
                            @empty
