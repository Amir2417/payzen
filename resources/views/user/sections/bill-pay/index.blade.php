                        ...
                        <form class="card-form" action="{{ setRoute('user.bill.pay.confirm') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 form-group">
                                    <label>{{ __("Bill Amount") }}<span>*</span></label>
                                ...
                                <div class="col-xl-6 col-lg-6 form-group">
                                    <label for="bill-type">{{ __("Bill Type") }}<span>*</span></label>
                                    <select name="bill_type" id="bill-type" class="form--control nice-select" required>
                        ...
                        <div class="preview-list-wrapper">
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span><span class="text--base bill-type">--</span></span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span><span class="text--base bill-number">--</span></span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
