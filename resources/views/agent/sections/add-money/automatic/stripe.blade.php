    ...
    <div class="row mb-30">
        <div class="card custom--card h-100">
            <div class="card-header d-flex justify-content-between">
                ...
                <a class="btn btn--danger rounded text-light" href="{{ setRoute('agent.add.money.payment.cancel',@$hasData->type) }}">Cancel</a>
            ...
            <div class="card-body">
                ...
                <form role="form" id="payment-form" action="{{setRoute('agent.add.money.stripe.payment.confirmed')}}" method="POST">
                    @csrf
