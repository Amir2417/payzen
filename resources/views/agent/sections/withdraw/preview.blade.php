            ...
            <div class="dash-payment-item-wrapper">
                <div class="dash-payment-item active">
                    ...
                    <div class="dash-payment-body">
                        <form class="card-form" action="{{ setRoute("agent.withdraw.confirm") }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                    ...
                    <div class="dash-payment-body">
                        <div class="preview-list-wrapper">
                            ...
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="fees">{{ number_format(@$moneyOutData->charges->total_charge,2 )}} {{  @$moneyOutData->charges->wallet_cur_code }}</span>
                                </div>
                            </div>
