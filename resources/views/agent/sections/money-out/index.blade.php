                        ...
                        <form class="card-form" action="{{ setRoute('agent.money.out.insert') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <button type="submit" class="btn--base w-100 btn-loading moneyOutBtn">{{ __("Withdraw Money") }} <i class="fas fa-arrow-alt-circle-right ms-1"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="dashboard-header-wrapper">
            ...
            <div class="dashboard-btn-wrapper">
                <div class="dashboard-btn mb-2">
                    <a href="{{ setRoute('agent.transactions.index','money-out') }}" class="btn--base">{{__("View More")}}</a>
                </div>
            </div>
        </div>
