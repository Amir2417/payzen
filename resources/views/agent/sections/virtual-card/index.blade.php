            ...
            <div class="dash-payment-item-wrapper">
                <div class="dash-payment-item active">
                    <div class="card-header-btn-wrapper d-flex align-items-center justify-content-between">
                        ...
                        @if( @$myCard == null)
                        <a href="javascript:void(0)" class="small--btn buyCard">Create <i class="fas fa-plus ms-1"></i></a>
                        @else
                            ...
                            <div class="card-custom">
                                <div class="flip">
                                    <div class="front bg_img" data-background="{{ asset('public/frontend/') }}/images/element/virtual-card.png">
                                         <img class="logo" src="{{ get_logo($basic_settings,'dark') }}"
                                            alt="site-logo">
                ...
                <div class="dash-payment-item active mb-0 rounded-0">
                    ...
                    <div class="row mt-20">
                        ...
                        <div class="col-xl-12 col-lg-12 form-group">
                            ...
                            <code class="d-block mt-10 text-end text--dark fw-bold balance-show">Available Balance {{ authWalletBalance() }} {{ get_default_currency_code() }}</code>
                        </div>
                        <div class="col-xl-12 col-lg-12 form-group">
                            <div class="note-area">
