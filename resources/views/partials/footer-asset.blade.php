...
<!-- jvectormap -->
<script src="{{ asset('public/frontend/') }}/js/jquery-jvectormap-1.2.2.min.js"></script>
<!-- jvectormap world -->
<script src="{{ asset('public/frontend/') }}/js/jquery-jvectormap-world-mill-en.js"></script>
