                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 form-group">
                                    <div class="forgot-item">
                                        <label><a href="{{ setRoute('merchant.password.forgot') }}" class="text--base">{{ __("Forgot Password?") }}</a></label>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="account-item text-center mt-10">
                                        <label>{{ __("Don't Have An Account?") }}<a href="{{ setRoute('merchant.register') }}" class="text--base">{{ __("Register Now") }}</a></label>
                                    </div>
                                </div>
                            </div>
                        </form>
